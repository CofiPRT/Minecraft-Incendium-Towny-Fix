...
summon minecraft:firework_rocket ~ ~0.1 ~ {Silent:1b,Motion:[0.0,0.0,0.0],ShotAtAngle:1,LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Flight:1,Explosions:[{Type:2,Flicker:0,Trail:0,Colors:[I;16777215]},{Type:2,Flicker:0,Trail:0,Colors:[I;16777175]},{Type:2,Flicker:0,Trail:0,Colors:[I;16777139]},{Type:2,Flicker:0,Trail:0,Colors:[I;16777099]},{Type:2,Flicker:0,Trail:0,Colors:[I;16777074]},{Type:2,Flicker:0,Trail:0,Colors:[I;16777041]}]}}},Tags:["in.holy_wrath_firework","in.holy_wrath_firework_explosion_big"]}

execute as @e[type=firework_rocket,tag=in.holy_wrath_firework,tag=!in.checked,distance=..20] run function incendium:misc/firework
