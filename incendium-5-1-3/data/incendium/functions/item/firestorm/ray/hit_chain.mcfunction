...
summon minecraft:firework_rocket ~ ~1 ~ {Silent:1b,Motion:[0.0,0.0,0.0],ShotAtAngle:1,LifeTime:0,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Flight:1,Explosions:[{Type:4,Flicker:0,Trail:0,Colors:[I;16725028]},{Type:4,Flicker:0,Trail:0,Colors:[I;16733476]},{Type:4,Flicker:0,Trail:0,Colors:[I;16742692]},{Type:4,Flicker:0,Trail:0,Colors:[I;16751908]},{Type:4,Flicker:0,Trail:0,Colors:[I;16759040]},{Type:4,Flicker:0,Trail:0,Colors:[I;16765184]}]}}},Tags:["in.firestorm_firework","in.firestorm_firework_explosion"]}
